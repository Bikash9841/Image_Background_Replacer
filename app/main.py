...
st.write("Upload an image, click somewhere on the desired item on the image and replace the background of your choice.")
    ...
    if col2_2.button('Replace Background', type='primary', use_container_width=True):
        ...
        if os.path.exists(filename) and st.session_state.p_prompt == u_prompt:
            ...
            placeholder0.markdown(
                "![Alt Text](https://media.giphy.com/media/E5p5arpofX17Lg9KO9/giphy.gif)")
